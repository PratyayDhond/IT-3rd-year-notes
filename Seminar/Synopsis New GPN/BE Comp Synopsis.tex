...
\begin{center}
\includegraphics[scale=0.8]{flutter.png}
\hfill
\includegraphics[scale=0.14]{dart.png} \hfill \\
\hfill 2.3.4.2 Flutter logo \hfill
2.3.4.3 Dart Logo \hfill
\end{center}
\begin{center}
...
\begin{itemize}
\item Flutter’s hot reload feature helps you quickly and easily experiment, build UIs, add features, and fix bugs.
\item Hot reload works by injecting updated source code files into the running Dart Virtual Machine (VM). 
\item After the VM updates classes with the new versions of fields and functions, the Flutter framework automatically rebuilds the widget tree, allowing you to quickly view the effects of your changes.\\
\end{itemize}
...
\hspace{0.2in} 
\begin{itemize}
\item So overall flutter is a very efficient and cost effective framework which has a high scope for development of cross platform as well as native applications in the present as well as upcoming future.
\end{itemize}
